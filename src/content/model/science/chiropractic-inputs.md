...
upstream:
  - id: P-002
    role: conceptual
    note: Revising P-002's net-positive improvement criterion would require reconsidering what counts as beneficial neuromotor change here; that criterion supplies no evidence that an input produces the proposed effect.
  - id: S-004
    role: empirical
    note: Revising S-004's perturbation mechanism would require reconsidering the proposed route from chiropractic inputs to beneficial neuromotor change; the general mechanism does not demonstrate its chiropractic instantiation or benefit.
related: []
version: '0.1'
updated: 2026-09-09
whatWouldChange: >-
