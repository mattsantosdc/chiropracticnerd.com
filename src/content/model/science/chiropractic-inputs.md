...
upstream:
  - id: M-005
    role: conceptual
    note: Revising M-005's net-positive improvement criterion would require reconsidering what counts as beneficial neuromotor change here; that criterion supplies no evidence that an input produces the proposed effect.
  - id: M-010
    role: empirical
    note: Revising M-010's perturbation mechanism would require reconsidering the proposed route from chiropractic inputs to beneficial neuromotor change; the general mechanism does not demonstrate its chiropractic instantiation or benefit.
related: []
version: '0.1'
updated: 2026-09-09
whatWouldChange: >-
...
The intentional use of an input is described separately from its empirical effects. Chiropractic instantiation of the proposed mechanism, beneficial neuromotor change, and selection validity have not been established by evidence documented in this entry. M-010's general mechanism hypothesis alone establishes none of those chiropractic-specific steps.
