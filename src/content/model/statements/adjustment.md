...
summary: An adjustment is a change in how the nervous system organizes muscle tone, posture or movement, caused by a chiropractic input. The term names the person's response; whether that response improves function is a separate question.
domain: philosophy
...
## A change in control and coordination

In this Model, an **adjustment** is a change in the person's organization of muscle control or coordination caused by a chiropractic input. **Neuromotor** refers to the nervous system's control of muscle tone, posture and movement; **reorganization** means a change in how that control or coordination is arranged. A **chiropractic input** is a deliberately applied stimulus involving mechanical interaction with the body and associated neural input or response, intended to influence neuromotor function. The adjustment is the response caused by it.
