...
Intention does not establish effect. Delivering an input that matches the working hypothesis does not prove that the targeted pattern was perturbed, that reorganization occurred, or that a benefit resulted. A-003 checks subsequent findings and permits stopping or revision.
