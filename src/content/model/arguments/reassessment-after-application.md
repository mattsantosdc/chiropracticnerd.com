...
That principle motivates S-016: reassess to retain, revise, or abandon the working hypothesis and to stop or consider a different subsequent input when justified. The comparison must concern the same target and relevant conditions, while allowing that the person's state may have changed. If S-014 warrants no input, the post-application sequence is not triggered.
