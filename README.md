...
Version 0.1 is deliberately low-resolution. It contains 31 statements, 39 direct revision dependencies, and nine structured arguments. Three Framework statements—including S-003's explicit reasoning and empirical testing method—organize these domains. The analytical workflow does not require Philosophy to precede Science in a reader's route:
