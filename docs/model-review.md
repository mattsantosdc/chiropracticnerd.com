...
Every change to statements, structured arguments, their schemas or page templates, or their governing policy requires an updated semantic audit. The working AI agent or a human editor performs the audit; a local script checks that the recorded review covers the current files. This is a focused whole-Model check for v0.1, separate from the deferred incremental engine in [review-invalidation-plan.md](review-invalidation-plan.md).
