...
upstream:
  - id: P-002
    role: conceptual
    note: Revising P-002's net-positive outcome criterion would require reconsidering how broader benefit is judged here, independently of whether a neuromotor response occurs; the value criterion supplies no evidence of transfer.
  - id: S-005
    role: empirical
    note: Revising S-005's proposed chiropractic production of beneficial neuromotor change would require reconsidering the input-produced changes whose broader effects are proposed here; even beneficial neuromotor change does not establish broader transfer or net benefit.
related: []
version: '0.1'
updated: 2026-09-09
whatWouldChange: >-
...
S-007 separately proposes neural mediation as the principal route to broader chiropractic effects. This entry concerns net-positive benefit; it does not require that neural mediation be the principal pathway. Neither hypothesis establishes the other.

## Current evidence

This entry has not yet documented evidence establishing the proposed broader beneficial transfer. A neuromotor response alone does not establish that transfer. Even if S-005's beneficial neuromotor-effect hypothesis is true, broader benefit requires separate evaluation.

## Boundary

“Some” specifies that the proposed transfer occurs in some cases, without a frequency estimate or a universal promise. This is the Model's hypothesis; its empirical support remains unresolved. Immediate change does not establish causation, durability, mechanism, or broader benefit. Evidence that an input changes a neuromotor measure must not stand in for evidence of transfer.
