---
id: ARG-009
slug: effect-from-perturbation
title: The improving effect follows from the perturbation claim
summary: The perturbation claim includes the improving effect in the same causal cases; the deduction preserves that effect without establishing the mechanism or replacing the independent empirical premise.
premises:
  - S-028
conclusion: S-011
...
The deduction does not establish the empirical truth of either statement or identify perturbation from an observed improvement. Some qualifying responses does not mean every input or every beneficial response uses this mechanism. The conclusion supplies neither a response frequency nor broader effects, predominance, durability beyond the specified interval, or justification for a particular input.
