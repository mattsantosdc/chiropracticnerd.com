...
S-013 retains S-007 and S-011 for neural integration and the input/response account; those two relationship decisions remain open. The S-012/S-013 pair, stored only on S-013, is see-also: broader improvement and principal neural mediation do not establish one another. S-031 stores a see-also link to S-012 because a predicted likelihood of broader processing change and beneficial occurrence are distinct claims, with neither entailing the other.
