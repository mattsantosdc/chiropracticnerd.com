...
The v0.1 graph contains 32 statements and 38 direct dependencies, alongside ten structured arguments. Every dependency has one of the five roles and a required limiting note. `related` links and arguments remain outside the acyclic dependency graph. The historical [reasoning audit](model-v0.1-reasoning-audit.md), [Stage 2 integration](model-stage-2-integration.md), and [Stage 3 integration](model-stage-3-integration.md) record the decisions; the graph is not a linear proof of chiropractic effectiveness.

S-021 supplies the independently specified comparison of context-appropriate function. S-022 depends conceptually on that definition. Its contribution to S-005's professional aim now follows ARG-007 through S-027 and ARG-008 with S-029's normative bridge. The former S-022 to S-005 dependency is retired, with its original note preserved in the migration record. The S-004 to S-005 dependency is also retired: open-ended potential provides context without establishing the aim's legitimacy. S-009, S-011, and S-012 now depend on S-021 for their empirical outcome meanings instead of treating S-005's aim as a definition of benefit.
...
S-028 retains the empirical explanatory use of S-010's general perturbation account. Its former S-011 dependency is retired, with the original role and limiting note preserved in the migration record. ARG-009 instead records the strict implication from S-028's mechanism-and-effect claim to S-011's effect. Its transposition carries negation of the effect to negation of the stronger claim; there is no positive inference from effect to mechanism. S-011 retains a separately disclosed ordinary-premise route, so removing the perturbation route need not remove the effect or its benefit and purpose consequences. S-015 translates S-028's proposed mechanism into intentional application. S-014 uses S-027's scoped benefit in prospective selection. S-016 additionally depends on S-025 for the meaning of success when interpreting findings; none of these dependencies validates a clinical method.

The S-011 to S-012 decision retains its legacy empirical-role dependency as an explicit semantic use of the local input/response account and the scope from which broader improvement is distinguished. It does not make local improvement a causal mediator or a sufficient premise. The original note remains in place and in the migration history. S-030 supplies the general circuit-influence account; S-031 separately proposes likely broader neural effects. S-012 allows both shared neural processes and influence between connected circuits, while retaining its independent empirical burden for qualifying improvement. The four new uses are S-008 to S-030, S-030 to S-031, S-024 to S-031, and S-030 to S-012; their exact roles and limits remain canonical in the downstream records. They were introduced after the migration source snapshot and are not relabeled as original legacy edges.

S-013 now proposes motor-related neural change as the predominant mediator. S-007's general integration is background only: its dependency is retired, its original limiting note remains in the migration record, and S-013 stores a see-also link. S-011's local input/response account remains an explicit semantic use with the original empirical role and limiting note. A fifth new use, S-030 to S-013, supplies the circuit-influence explanation without establishing chiropractic mediation or predominance. It is also authored after the original snapshot. S-013 stores see-also links to S-012 and S-031: broader benefit, likely broader processing change, and predominant mediation do not establish one another. S-031's see-also link to S-012 remains. No inference application is introduced by these decisions.
...
The S-014 to S-015 dependency is retired in favor of ARG-010's joint S-014/S-032 practical argument. Its original role and note remain in the migration inventory. S-028 to S-015 retains its exact practical role and note as mechanism guidance, independently of the new argument: a change to the mechanism requires reconsidering predictions and choices without automatically negating a separately justified application. S-015 is derived only; no-input and uncertain-response conditions remain. All 38 original migration entries now have an explicit decision, while removing the remaining redundant legacy fields is separate structural work.
